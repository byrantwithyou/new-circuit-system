                ...
                <el-tab-pane label="other settings" name="forth">
                    <el-container style="position: relative;margin:auto">
                        <el-form :model="settings" style="position: relative;margin:auto">
                            ...
                            <el-form-item label="How many times can a student be deemed to have been familiar with a behavior if he makes a mistake?">
                                <br>
                                <el-select v-model="settings.trueTimesMistake" placeholder="Please choose" style="position: absolute;right: 0px" @change="sendUpdateAuthoring">
                                    <el-option label="1" value="1"></el-option>
                                    <el-option label="2" value="2"></el-option>
                                    <el-option label="3" value="3"></el-option>
                                    <el-option label="4" value="4"></el-option>
